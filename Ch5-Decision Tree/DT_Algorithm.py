# 参考《机器学习实战》 Peter
# 可以根据需要修改特征选择依据，将chooseBestFeatureToSplit函数中的内容注释掉来得到ID3算法和C4.5算法
# 本程序还给出了分类树的可视化实现
...
def createTree(dataSet,labels,featlabels):
    ...
    for val in uniqueBestFeatVals:
        subLabels = labels[:]
        myTree[bestFeatLabel][val] = createTree(splitDataSet(dataSet,bestFeat,val),subLabels,featlabels)
